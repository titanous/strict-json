...
var unmarshalTests = []unmarshalTest{
	...
	{in: `{"x": 1}`, ptr: new(tx), out: tx{}, err: &UnmarshalKeyError{"x"}},
	...
	// Z has a "-" tag.
	{in: `{"Y": 1, "Z": 2}`, ptr: new(T), out: T{Y: 1}, err: &UnmarshalKeyError{"Z"}},

	{in: `{"alpha": "abc", "alphabet": "xyz"}`, ptr: new(U), out: U{Alphabet: "abc"}, err: &UnmarshalKeyError{"alphabet"}},
	{in: `{"alpha": "abc"}`, ptr: new(U), out: U{Alphabet: "abc"}},
	{in: `{"alphabet": "xyz"}`, ptr: new(U), out: U{}, err: &UnmarshalKeyError{"alphabet"}},
